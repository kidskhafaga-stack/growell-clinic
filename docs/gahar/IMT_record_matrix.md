...
### ٣ — مفيش مراجعة اكتمال الملف (IMT.09) — **اللي فاضل**
...
وده اللي البرنامج يقدر يحمله **كامل** — العيّنة والنسبة والربع سنوي
والاكتمال كلهم حساب. وبقى فيه حاجات يقيسها فعلاً: `discharge_summary.
unwritten()` بترجّع الإقامات اللي خلصت من غير ملخّص، و`state` بترجّع
`short` للي ناقصة بنود، والـchecklist في العمليات بتقول مين وقّع ناقص.
