...
KEEP = {
    ...
    "implant_devices",
    # `SAS.19` — قايمة اللي أوضة الإفاقة لازم تبقى شايلاه: كتالوج المكان.
    "recovery_items",
    # باب المطوّر: الشبابيك اللي المالك فتحها وكل اللي اتعمل جواها. «امسح
    # البيانات» بيبدأ شغل العيادة من جديد، ما بيمحيش إن حد من بره دخل.
    "support_windows", "support_actions",
}
...
OPERATIONAL = {
    ...
    "implant_recalls",
    # `SAS.19` — جولات فحص أوضة الإفاقة: شغل تشغيلي مالوش مريض.
    "recovery_checks", "recovery_check_lines",
}
